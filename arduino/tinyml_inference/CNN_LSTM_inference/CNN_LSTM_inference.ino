/*
  BSL Gesture Recognition System - CNN_LSTM Inference Firmware
  ...
  - CNN_LSTM TensorFlow Lite model inference
...
constexpr int kTensorArenaSize = 40 * 1024; // CNN-LSTM needs ~35KB, increased to 40KB
