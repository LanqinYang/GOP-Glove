...
void setup() {
  ...
  setup_tf();
  Serial.println("Transformer Encoder LOSO latency tester ready. Type 'help'.");
}
...
void loop() {
  if (Serial.available()) {
    ...
    else if (line.equalsIgnoreCase("record")) { capture_window(window_fixed); has_fixed_window = true; Serial.println("OK: recorded fixed window"); }
